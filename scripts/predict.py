...
if __name__ == "__main__":
    ...
    deeplab = DeeplabV3(
        num_classes=19,
        model_path='logs_mobilenetv2rein/best_epoch_weights.pth',  # 使用mobilenetv2rein训练的最优权重
        backbone='mobilenet',  # 主干与训练保持一致
        use_tokens=True
    )
    #----------------------------------------------------------------------------------------------------------#
    #   mode用于指定测试的模式：
    ...
    #-------------------------------------------------------------------------#
    count           = True
    name_classes    = ["_background_" ,"road" , "sidewalk" , "building" ,"wall" ,"fence" ,"pole" ,"traffic light", "traffic sign","vegetation" ,"terrain" ,"sky" ,"person" ,"rider" ,"car" ,"truck" ,"bus" ,"train" ,"motorcycle", "bicycle"]
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 160
    fps_image_path  = "img/berlin00.png"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "E:/deeplearning/deeplabv3plus/data/processed/img/"  # 预测图片文件夹
